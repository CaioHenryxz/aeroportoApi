package br.gm.caio.airports.entities;
...
/**
 * Entidade que representa a tabela airport no banco de dados.
 * @author digma
 */
@Entity
@Table(name = "airport")
public class Airport {
    ...
    // Eles permitem que o Spring converta o objeto para JSON no Postman
